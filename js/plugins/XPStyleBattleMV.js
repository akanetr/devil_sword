/*:
 * @plugindesc XPStyleBattle for MV Build181108
 ...
 * @min 0
 * @max 4096
 * @desc The minimum value of y coordinate. [Default: 112]
 * 
 ...
 * @min -4096
 * @max 4096
 * @desc The adjustment y coordinate. [Default: -72]
 *
        ...
        (function (Property) {
            ...
            (function (PropertyUtility) {
                ...
                (function (definitions) {
                    ...
                    definitions.string = new pd({ key: "fontFace", type: "String", defaultValue: "\'Text\'" });
                    definitions.color = new pd({ key: "color", type: "String", defaultValue: "\'Green\'" });
                    definitions.outlineColor = new pd({ key: "color", type: "String", defaultValue: "\'Green\'" });
        ...
        (function (Targeting) {
            ...
            var TargetInformationWindow = (function (_super) {
                ...
                TargetInformationWindow.prototype._drawTargetInformation = function (battler) {
                    ...
                    var margin = 8;
                    var gaugesBaseX = this.contentsWidth() - gaugeWidth * gauges;
                    var col = 0;
                    if (settings.hp) {
                    ...
                    if (settings.states) {
                        nameX -= battler.allIcons().length * Window_Base._iconWidth / 2;
                        nameX = nameX.clamp(0, this.contentsWidth());
                    }
                    if (battler.isActor() || settings.hp) {
                        this.drawActorName(battler, nameX, 0, 0xffffffff);
                    }
                    else {
                    ...
                    if (settings.states) {
                        ...
                        var statusWidth = gaugesBaseX - statusX - margin;
