...
/*:
 * @plugindesc 【2018/12/22】不具合修正プラグイン
 * @author 木星ペンギン
 *
...
//466
Alias.BaMa_processForcedAction2_patch15 = BattleManager.processForcedAction;
BattleManager.processForcedAction = function() {
    this._tuenEndAction = (this._tuenEndAction || this._phase === 'turnEnd');
    Alias.BaMa_processForcedAction2_patch15.apply(this, arguments);
